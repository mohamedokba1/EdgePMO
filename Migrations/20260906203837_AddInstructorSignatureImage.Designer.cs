...
namespace EdgePMO.API.Migrations
{
    ...
    [Migration("20260906203837_AddInstructorSignatureImage")]
    partial class AddInstructorSignatureImage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EdgePMO.API.Models.KnowledgeHubSection", b =>
                {
                    ...
                    b.Property<Guid>("KnowledgeHubId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EdgePMO.API.Models.MediaFolder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("EdgePMO.API.Models.PromoCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("EdgePMO.API.Models.VideoWatchProgress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("CourseVideoId", "UserId")
                        .IsUnique();

                    b.ToTable("VideoWatchProgresses");
                });
            ...
            modelBuilder.Entity("EdgePMO.API.Models.ContentBlock", b =>
                {
                    b.HasOne("EdgePMO.API.Models.KnowledgeHubSection", "Section")
                        .WithMany("Blocks")
            ...
            modelBuilder.Entity("EdgePMO.API.Models.KnowledgeHubSection", b =>
                {
                    b.HasOne("EdgePMO.API.Models.KnowledgeHub", "KnowledgeHub")
                        .WithMany("Sections")
                        .HasForeignKey("KnowledgeHubId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("KnowledgeHub");
                });

            modelBuilder.Entity("EdgePMO.API.Models.MediaFile", b =>
                {
                    b.HasOne("EdgePMO.API.Models.MediaFolder", "Folder")
                        .WithMany()
            ...
            modelBuilder.Entity("EdgePMO.API.Models.MediaFolder", b =>
                {
                    b.HasOne("EdgePMO.API.Models.MediaFolder", "ParentFolder")
                        .WithMany()
            ...
            modelBuilder.Entity("EdgePMO.API.Models.VideoWatchProgress", b =>
                {
                    b.HasOne("EdgePMO.API.Models.CourseVideo", "CourseVideo")
                        .WithMany()
